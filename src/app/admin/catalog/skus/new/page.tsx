      ...
      <section className="admin-shell admin-editor">
        <AdminBreadcrumbs
          items={[
            ...
            { href: "/admin/catalog/skus", label: "SKU / Packages" },
            { label: "สร้างใหม่" },
          ]}
        />
        <p className="section-kicker">ADMIN / CATALOG / SKUS</p>
        <h1>New SKU</h1>
        <p>Active SKU ต้องให้สิทธิ์เฉพาะ Product ที่ Published แล้ว</p>
        <SkuForm
          action={createSkuAction}
          cancelHref="/admin/catalog/skus"
